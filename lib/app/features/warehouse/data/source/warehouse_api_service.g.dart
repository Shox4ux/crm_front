...
part of 'warehouse_api_service.dart';
...
class _WarehouseApiService implements WarehouseApiService {
  ...
  @override
  Future<HttpResponse<List<WarehouseResponse>>> getAllWarehouse() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<List<WarehouseResponse>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/warehouses/get_all',
    ...
    late List<WarehouseResponse> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                WarehouseResponse.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
  ...
  @override
  Future<HttpResponse<dynamic>> deleteWarehouse({required int id}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
