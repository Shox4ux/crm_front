...
part of 'order_pro_api_service.dart';
...
class _OrderProApiService implements OrderProApiService {
  ...
  Future<HttpResponse<dynamic>> createOrderProd({
    required OrderProBulkCreate body,
  }) async {
  ...
  @override
  Future<HttpResponse<List<OrderResponse>>> getAllOrderProd() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<HttpResponse<List<OrderResponse>>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
