...
import 'package:crm_app/app/src/data/remote/models/request/client/client_prod_update.dart';
...
class ClientCubit extends Cubit<ClientState> {
  ...
  late List<ClientRead> _filtered;
  ...
  List<ClientRead> getFiltList() => _filtered;
  ...
  void createClient({ClientWrite? cbody, UserWrite? ubody}) async {
    emit(state.copyWith(status: ClientStatus.loading));
  ...
  void _createActualClient(ClientWrite cbody) async {
    emit(state.copyWith(status: ClientStatus.loading));
  ...
  void onClientPressed(ClientRead client) =>
